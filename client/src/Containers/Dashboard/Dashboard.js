...
=======
                        <div onClick={() => window.open("https://www.facebook.com", '_blank')} className={styles.col} style={{ backgroundColor: "#0084ff" }}><img className={styles.icon} src={messengerIcon} alt="icon" height="30" /> Share</div>
>>>>>>> 8cf8fdcf520ac9234bd3a6affda6362cb5daf231
